...
sudo nix run --extra-experimental-features "nix-command flakes" 'github:nix-community/disko/latest#disko-install' -- --flake "./machines/dev-machine#devmachine" --disk main /dev/sda
